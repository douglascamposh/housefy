...
import { useCreateSubPropertiesMutation,useUpdateSubPropertiesMutation } from '@/redux/services/propertiesApi';
import { toast } from "react-toastify";

const SubPropertyCreateUpdate = ({idSvg, idProperty,data, newSubproperty,onClose,onCloseForm}) => {
  const [createSubProperty, { isLoading }] = useCreateSubPropertiesMutation();  
  const [updateSubProperty, { isLoading: updateLoading }] = useUpdateSubPropertiesMutation({
